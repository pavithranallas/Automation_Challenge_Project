...
public class Compare_JSON {
	...
	public static void main(String[] args) throws JsonProcessingException, DatabindException, IOException {
		...
		List<StateCode> statecodelist1 = mapper.readValue(new File("./fileone.json"), new TypeReference<List<StateCode>>() {});
		//System.out.println(statecodelist1);
	
		List<StateCode> statecodelist2 = mapper.readValue(new File("./filetwo.json"), new TypeReference<List<StateCode>>() {});
